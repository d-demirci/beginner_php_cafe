...
<div id="page-wrapper">
  ...
  <form action="includes/islem.php" method="POST" enctype="multipart/form-data">
    ...
    <div align="center" class="form-group col-md-3"> 
      ...
      <p align="left"><input class="btn btn-success" type="submit" name="tatlilarkaydet" value="Tatlı Kaydet">
      </p>
    </div>
    ...
    <div class="col-md-4">
      <div class="form-group">
        <label class="control-label col-lg-12">Tatlı Resim</label>
        <div class="">
          <div class="fileupload fileupload-new" data-provides="fileupload">
            <span class="btn btn-file btn-default">
              <span class="fileupload-new">Resim Seç</span>
              <span class="fileupload-exists">Değiştir</span>
              <input type="file" name="tatli_resimyol">
            </span>

...
<div id="page-wrapper">
  ...
  <form action="includes/islem.php" method="POST" enctype="multipart/form-data">
    ...
    <div align="center" class="form-group col-md-3"> 
      ...
      <p align="left"><input class="btn btn-success" type="submit" name="yemekkaydet" value="Yemek Kaydet">
      </p>
    </div>
    ...
    <div class="col-md-12">
      <div class="form-group col-md-12">
        ...
        <input class="form-control" type="text" name="anayemek_ad" placeholder="Yemek Adı Girin">
      </div>


      <div class="col-md-12">
      <div class="form-group col-md-12">
        <label>Ana Yemek Ücret</label>
        <input class="form-control" type="text" name="anayemek_fiyat" placeholder="Ana Yemek Ücret Girin">
      </div>
    ...
    <div class="col-md-4">
      <div class="form-group">
        <label class="control-label col-lg-12">Ana Yemek Resim</label>
        <div class="">

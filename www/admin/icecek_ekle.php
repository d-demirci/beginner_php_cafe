...
<div id="page-wrapper">
  <div id="page-inner">
    <div class="row">
      <div class="col-md-12">
        <h1 style=color:red class="page-head-line">İçecek Ekleme</h1>
  ...
  <form action="includes/islem.php" method="POST" enctype="multipart/form-data">
    ...
    <div align="center" class="form-group col-md-3"> 
      ...
      <p align="left"><input class="btn btn-success" type="submit" name="icecekkaydet" value="İçecek Kaydet">
      </p>
    </div>
    ...
    <div class="col-md-4">
      <div class="form-group">
        <label class="control-label col-lg-12">icecek Resim</label>
        <div class="">

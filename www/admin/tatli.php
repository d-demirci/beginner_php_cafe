...
<div id="page-wrapper">
    <div id="page-inner">
        <div class="row">
            ...
            <div class="col-md-12">
             <a href="tatli_ekle.php"><button class="btn btn-success">Tatlı Ekle</button>
                <hr>
            </div>
            <div class="col-md-12">
               <!--    Hover Rows  -->
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php 
                                $menusor=$db->query("select * from gmenu_tatli ");
                                ...
                                while ($menucek=$menusor->fetch()) {?>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="netting/islem.php?tatli_id=<?php echo $menucek['tatli_id']; ?>&tatlisil=ok"><button class="btn btn-danger">Sil</button></a></td>
                                    </tr>
                                <?php } ?>
